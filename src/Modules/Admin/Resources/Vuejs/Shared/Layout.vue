    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex justify-between px-2 py-4 bg-indigo-900 md:flex-shrink-0  md:w-56">
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-2 w-56 bg-indigo-800 overflow-y-auto md:block" />
